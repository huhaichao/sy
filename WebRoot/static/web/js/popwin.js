var popWin = {
	...
	showWin: function(a, b, c, d) {
		...
		h += '<div id="maskTitle" style="height:35px; line-height: 35px; font-family:Arial; font-size: 14px; font-weight:bold; color: #797979; padding-left: 10px; background: url(./images/hbbg.png); border-bottom: 1px solid #d1d1d1; position: relative;">',
		h += "" + c,
