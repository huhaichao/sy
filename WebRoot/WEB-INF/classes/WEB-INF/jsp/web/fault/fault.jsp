...
<body>
	<div id="moquu_wxin" class="moquu_wxin">
		<a href="javascript:alert('iOS');">iOS
			<div class="moquu_wxinh"></div>
		</a>
	</div>
	<div id="moquu_wshare" class="moquu_wshare">
		<a href="javascript:alert('android');">android
			<div class="moquu_wshareh"></div>
		</a>
	</div>
	<div id="moquu_wmaps" class="moquu_wmaps">
		<a href="javascript:alert('电话');">电话
	...
	<div class="page-wrapper">
					...
					<div class="col-xs-10 col-sm-6">
						...
						<div id="header-top-second" class="clearfix"
							...
							<div class="header-top-dropdown">
								...
								<div class="btn-group dropdown">
									<button id="btnlogin" type="button" class="btn dropdown-toggle">
										<i class="glyphicon glyphicon-phone"></i>&nbsp;<a href="#">登录</a>
									</button>
								</div>
								<div class="btn-group dropdown">
									<button id="btnregist" type="button"
										class="btn dropdown-toggle">
										<i class="glyphicon glyphicon-user"></i>&nbsp;<a href="#">注册</a>
									</button>
								</div>
								<div class="btn-group dropdown">
									<button id="btnuser" type="button" class="btn dropdown-toggle">
										<i class="fa fa-user"></i>&nbsp;<a id="username" href="#">未登陆</a>
									</button>
								</div>
								<div class="btn-group dropdown">
									<button id="btnlogout" type="button"
										class="btn dropdown-toggle">
										<i class="glyphicon glyphicon-off"></i>&nbsp;<a href="#">退出</a>
									</button>
								</div>
							</div>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<div class="header-left clearfix">
						<!-- logo -->
						<div class="logo">
							<a href="index.html"><img id="logo" src="../static/web/images/logo_red.png"
								alt="iDea"></a>
						</div>
						<!-- name-and-slogan -->
						<div class="site-slogan">irevest_拾缘科技</div>
					</div>
					<!-- header-left end -->
				</div>
				<div class="col-md-9">
								...
								<div class="collapse navbar-collapse" id="navbar-collapse-1">
									<ul class="nav navbar-nav navbar-right">
										...
										<li class="dropdown"><a href="#" class="dropdown-toggle"
											data-toggle="dropdown">统计</a>
											<ul class="dropdown-menu">
												<li><a href="#">注册用户量</a></li>
												<li><a href="#">在线用户量</a></li>
											</ul></li>
										<li class="dropdown"><a href="#" class="dropdown-toggle"
											data-toggle="dropdown">浏览</a>
											<ul class="dropdown-menu">
						...
						<div class="overlay-container">
							...
							<div class="overlay">
								<div class="overlay-links">
									<a href="blog-post.html"><i class="fa fa-link"></i></a> <a
										href="../static/web/images/blog-sidebar.jpg" class="popup-img-single"
							...
							<div class="row">
								<div class="col-lg-8 col-lg-offset-1">
									<div class="form-group">
										<label for="billingLastName" class="col-md-2 control-label">主题</label>
										<div class="col-md-10">
									...
									<div class="form-group">
										<label for="billingTel" class="col-md-2 control-label">反馈内容</label>
										<div class="col-md-10">
									...
									<div class="form-group" style="text-align: right;">
										<div id="btnSend" 
											style="text-align: right;">
											<a id="asend" class="btn radius btn-white btn-sm">提交</a>
										</div>
									</div>
								</div>
							</div>
		...
		<!-- section start -->
		<!-- ================ -->
		<div class="section gray-bg object-non-visible"
						...
						<div class="row">
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="testimonial-image">
									<img src="../static/web/images/testimonial-1.jpg" alt="Jane Doe"
										title="Jane Doe" class="img-circle">
								</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="testimonial-image">
									<img src="../static/web/images/testimonial-2.jpg" alt="Jane Doe"
										title="Jane Doe" class="img-circle">
								</div>
								<div class="testimonial-body">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2">
								<h2 class="title">失踪儿童</h2>
								<div class="testimonial-image">
									<img src="../static/web/images/testimonial-3.jpg" alt="Jane Doe"
										title="Jane Doe" class="img-circle">
								</div>
								<div class="testimonial-body">
									<p>失踪儿童的详细描述信息！失踪儿童的详细描述信息！失踪儿童的详细描述信息！失踪儿童的详细描述信息！失踪儿童的详细描述信息！.</p>
					...
					<div class="col-md-6">
						<div class="footer-content">
							<div class="logo-footer">
								<img id="logo-footer" src="../static/web/images/logo_red_footer.png" alt="">
							</div>
							<div class="row">
								<div class="col-sm-6">
									...
									<ul class="social-links circle">
										<li class="facebook"><a target="_blank"
											href="http://sc.chinaz.com"><i class="fa fa-facebook"></i></a></li>
										<li class="twitter"><a target="_blank"
											href="http://sc.chinaz.com"><i class="fa fa-twitter"></i></a></li>
										<li class="googleplus"><a target="_blank"
											href="http://sc.chinaz.com"><i class="fa fa-google-plus"></i></a></li>
										<li class="skype"><a target="_blank"
											href="http://sc.chinaz.com"><i class="fa fa-skype"></i></a></li>
										<li class="linkedin"><a target="_blank"
											href="http://sc.chinaz.com"><i class="fa fa-linkedin"></i></a></li>
									</ul>
								</div>
								<div class="col-sm-6">
									<ul class="list-icons">
						...
						<div class="footer-content">
							...
							<div class="gallery row">
								<div class="gallery-item col-xs-4">
									<div class="overlay-container">
										<img src="../static/web/images/gallery-1.jpg" alt=""> <a
											href="portfolio-item.html" class="overlay small"> <i
											class="fa fa-link"></i>
										</a>
									</div>
								</div>
								<div class="gallery-item col-xs-4">
									<div class="overlay-container">
										<img src="../static/web/images/gallery-2.jpg" alt=""> <a
											href="portfolio-item.html" class="overlay small"> <i
											class="fa fa-link"></i>
										</a>
									</div>
								...
								<div class="gallery-item col-xs-4">
									<div class="overlay-container">
										<img src="../static/web/images/gallery-3.jpg" alt=""> <a
											href="portfolio-item.html" class="overlay small"> <i
											class="fa fa-link"></i>
										</a>
									</div>
								...
								<div class="gallery-item col-xs-4">
									<div class="overlay-container">
										<img src="../static/web/images/gallery-4.jpg" alt=""> <a
											href="portfolio-item.html" class="overlay small"> <i
											class="fa fa-link"></i>
										</a>
									</div>
								...
								<div class="gallery-item col-xs-4">
									<div class="overlay-container">
										<img src="../static/web/images/gallery-5.jpg" alt=""> <a
											href="portfolio-item.html" class="overlay small"> <i
											class="fa fa-link"></i>
										</a>
									</div>
								...
								<div class="gallery-item col-xs-4">
									<div class="overlay-container">
										<img src="../static/web/images/gallery-6.jpg" alt=""> <a
											href="portfolio-item.html" class="overlay small"> <i
											class="fa fa-link"></i>
										</a>
									</div>
	...
	<script type="text/javascript">
		...
		function send() {
			if (check()) {
				var sendtitle = $("#billingLastName").val();
