					...
					<div class="row">
						<div class="col-md-12">
							<ol class="breadcrumb">
								...
								<li class="active"><a href="people_list.html">寻人列表</a></li>
                                <li class="active">寻人明细</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-12">
							...
							<!-- page-title start -->
							<!-- ================ -->
							<h1 class="page-title margin-top-clear">周小伦</h1>
							<!-- page-title end -->
										...
										<div class="side product-item vertical-divider-left">
											<div class="tabs-style-2">
												...
												<ul class="nav nav-tabs" role="tablist">
													...
													<li><a href="#h2tab2" role="tab" data-toggle="tab"><i class="fa fa-files-o pr-5"></i>联系人</a></li>
													<li><a href="#h2tab3" role="tab" data-toggle="tab"><i class="fa fa-star pr-5"></i>备用</a></li>
												</ul>
												<!-- Tab panes -->
												<div class="tab-content padding-top-clear padding-bottom-clear">
													<div class="tab-pane fade in active" id="h2tab1">
														<h4 class="space-top">周小伦</h4>
														<hr>
                                                        <dl class="dl-horizontal">
                                                            ...
                                                            <dd>￥8000.00</dd>
															<dt>走失地点</dt>
															<dd>北京市公安局通州分局梨园派出所</dd>
                                                            <dt>体貌特征</dt>
															<dd>身高178，上衣T桖，牛仔裤！</dd>
                                                            <dd><a href="#" class="btn radius btn-light-gray btn-sm">收藏</a></dd>
														</dl>
														<hr>
													</div>
													<div class="tab-pane fade" id="h2tab2">
														<h4 class="space-top">周大伦</h4>
														<hr>
														<dl class="dl-horizontal">
															<dt>姓名</dt>
															<dd>周大伦</dd>
															...
															<dt>积分</dt>
															<dd>100</dd>
                                                            <dd><a href="#" class="btn radius btn-light-gray btn-sm">联系人</a>
                                        					<a href="#" class="btn radius btn-light-gray btn-sm">聊天室</a>
                                       					    <a href="#" class="btn radius btn-light-gray btn-sm">确认归还</a></dd>
														</dl>
														<hr>
													</div>
